    ...
    function comefrom(loca, locashi) {
        this.loca = loca;
        this.locashi = locashi;
    }
    ...
    where[12] = new comefrom("浙江", "州|宁波|温州|嘉兴|湖州|绍兴|金华|衢州|舟山|台州|丽水");
    ...
    function select() {
        ...
        document.user_reg.address.value = loca2 + loca4;
    }
