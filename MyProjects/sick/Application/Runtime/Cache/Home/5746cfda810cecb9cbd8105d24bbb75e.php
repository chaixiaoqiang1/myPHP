...
<head>
    ...
    <link href="/public_html/Public/newuser/css/bootstrap.css" rel="stylesheet">

    <link rel="stylesheet" href="/public_html/Public/newuser/css/change.css"/>
...
<div class="container">
            ...
            <div class="user_info fl">
                <div class="user_head">
                   <p style="margin-top: 20px; text-align: center;">
                       <img alt="" class="img-responsive img-circle" src="<?php echo ($list["icon"]); ?>" style="width:60px; height: 60px; border-radius: 50%;">
                   </p>
                </div>
            </div>
            <div class="money" style="margin: 0; padding-top: 3%;">
    ...
    <div class="row content">
        <div class="col-md-12 col-sm-12 col-xs-12 pd">
            <a href="<?php echo U('Newuser/recharge');?>" class="fl"style="display: block">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 pd"style="border: none">
            <a href="<?php echo U('Newuser/withdraw_deposit');?>" class="fl" style="display: block">
