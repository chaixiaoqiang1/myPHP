                    ...
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 pull-right">
                        <form class="form-horizontal" method="post" id="user-editor" enctype="multipart/form-data" action="<?php echo U('User/index');?>">
                            <div class="row form-group">
                               ...
                               <!--     <a href="<?php echo U('Service/orderset');?>">  <button type="button" class="btn btn-primary">预约设置</button></a>-->
                ...
                <div class="row">
                    <table class="table table-bordered">
                        ...
                        <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-center">
                            ...
                            <!--    <td class="info">
                                    <a href="<?php echo U('Service/orderset',array('id'=>$vo['id']));?>">
                                        <span class="label btn-success">点击设置</span>
                                    </a>
                                </td>-->
                              <!--  <td class="info col-md-3">
                                    <a href="<?php echo U('Service/orderstatus',array('id'=>$vo['id']));?>">
                                        <span class="label btn-warning">冻结</span>
                                    </a>
                                    <a href="<?php echo U('Service/orderstatus',array('id'=>$vo['id']));?>">
                                        <span class="label btn-success">正常</span>
                                    </a>
                                    <a href="<?php echo U('Service/orderedit',array('id'=>$vo['id']));?>">
                                        <span class="label btn-primary">修改</span>
                                    </a>
                                    <a href="<?php echo U('Service/orderdel',array('id'=>$vo['id']));?>">
