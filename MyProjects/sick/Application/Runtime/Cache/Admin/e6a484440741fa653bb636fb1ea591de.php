            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 shop_list">
                <div class="row">
                    ...
                    <table class="table table-striped">
                        <?php if($info['sex'] == 2): ?><tr>
                            <th>末次月经时间</th>
                            <td><?php echo ($info['lastyuejing']); ?>
                            </td>
                        </tr>
                        <tr>
                            <th>平均月经周期</th>
                            <td><?php echo ($info['pjyuejingzhouqi']); ?></td>
                        </tr>
                        <tr>
                            <th>平均月经时长</th>
                            <td><?php echo ($info['pjyuejingshichang']); ?></td>
                        </tr>
                        <tr>
                            <th>是否已育</th>
                            <td>
                                <?php if($info['is_bady'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>是否怀孕中</th>
                            <td>
                                <?php if($info['is_pregnancy'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                            </td>
                        </tr><?php endif; ?>
                        <!--生活习惯部分-->
                        ...
                        <tr>
                            <th>抽烟</th>
                            <td>
                                <?php if($info['is_smoking'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>饮酒</th>
                            <td>
                                <?php if($info['is_drink'] == 1): ?>从不
                                    <?php elseif($info['is_drink'] == 2): ?>偶尔
                                    <?php elseif($info['is_drink'] == 3): ?>经常
                                    <?php elseif($info['is_drink'] == 4): ?>每天<?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>饮食是否规律</th>
                            <td>
                                <?php if($info['is_yingshi'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>睡眠是否规律</th>
                            <td>
                                <?php if($info['is_xiuxi'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>大小便是否正常</th>
                            <td>
                                <?php if($info['is_wc'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th>是否长期服用止痛药或镇定催眠药</th>
                            <td>
                                <?php if($info['is_fuyao'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                            </td>
                        </tr>
