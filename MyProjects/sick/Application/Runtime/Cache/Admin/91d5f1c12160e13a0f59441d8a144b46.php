            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 shop_list">
                <div class="row">
                    <table class="table table-bordered">
                        ...
                        <!--+ 选项-->
                        <!--完整内容 	id id主键	grade 评分	content 评分内容	s_id 评论用户id	gradetime 评论时间	is_status 状态 1正常 2冻结	d_id 医生id-->
                        <!--序号 	用户名 	评论内容 	评分 	评分时间 	操作-->
                        ...
                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-center">
                                <td class="info"><?php echo ($k); ?></td>
                                <td class="info">
                                    <?php echo ($vo['s_id']['username']); ?>
                                </td>
                                <td class="info" >
                                    <?php echo ($vo["content"]); ?>
                                </td>
                                ...
                                <td class="info">
                                 <?php echo (date("y-m-d",$vo["gradetime"])); ?>
                                </td>
                            ...
                            <!--    <td class="info">
                                ...
                                <td class="info">
                                        <a href="<?php echo U('Service/sickcommentstatus',array('id'=>$vo['id']));?>">
                                            <span class="label btn-warning">冻结</span>
                                        </a>
                                        <a href="<?php echo U('Service/sickcommentstatus',array('id'=>$vo['id']));?>">
                                            <span class="label btn-success">正常</span>
                                        </a>
                                        <a href="<?php echo U('Service/sickcommentdel',array('id'=>$vo['id']));?>">
