                      ...
                      <!--  <form class="form-horizontal" method="post" id="user-editor" enctype="multipart/form-data" action="<?php echo U('User/index');?>">
                            <div class="row form-group">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <a href="<?php echo U('Service/servicelist');?>">  <button type="button" class="btn btn-primary">返回列表</button></a>
                                </div>
                            </div>
                        </form>-->
                    </div>
                ...
                <div class="row">
                    <table class="table table-bordered">
                        <tr class="text-center">
                            ...
                            <td class="active">服务时间</td>
                            <td class="active">科室</td>
                            <td class="active">主治医生</td>
                            <td class="active">患者姓名</td>
                            <td class="active">是否支付</td>
                            <td class="active">聊天信息</td>
                            <td class="active">状态</td>

                           <!-- <td class="active">第三方意见</td>-->
                        ...
                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-center">
                                ...
                                <td class="">
                                    <?php if($vo['type'] == 1): ?><p style="color:red">图文咨询</p>
                                        <?php elseif($vo['type'] == 2): ?>
                                            <p style="color:#0000cc ">预约咨询</p>
                                        <?php elseif($vo['type'] == 3): ?>
                                            <p style="color:green">免费咨询</p><?php endif; ?>
                                </td>
                                <td class="">
                                    <?php echo date("Y-m-d",$vo['servetime']);?>
                                </td>
                                <td class="">
                                    <?php echo ($vo["office"]); ?>
                                </td>
                                ...
                                <td class="">
                                    <a href="<?php echo U('Service/liaotian',array('fid'=>$vo['id'],'did'=> $vo['d_id']));?>">
                                        <span class="label btn-success">点击查看</span>
                                    </a>
                                </td>
                                <!--<td class="info">
                                    <a href="<?php echo U('Service/threeidea',array('id'=>$vo['s_id']));?>">
                                        <span class="label btn-warning">查看意见</span>
                                    </a>
                                </td>-->
                               <!-- <td class="info">
                                    <?php if($vo['is_status'] == 1): ?>正常
                                        <?php elseif($vo['is_status'] == 2): ?>冻结<?php endif; ?>
                                </td>-->
                                <td class="">
                                    <?php if($vo['is_status'] == 1): ?>进行中
                                        <?php elseif($vo['is_status'] == 2): ?>完成待评价
                                        <?php elseif($vo['is_status'] == 3): ?>完成已评价
                                        <?php elseif($vo['is_status'] == 4): ?>冻结不显示<?php endif; ?>
                                </td>
                               <!-- <td class="">
                                   &lt;!&ndash; <a href="<?php echo U('Service/servicestatus',array('id'=>$vo['serviceid']));?>">
                                        <span class="label btn-warning">冻结</span>
                                    </a>
                                    <a href="<?php echo U('Service/servicestatus',array('id'=>$vo['serviceid']));?>">
                                        <span class="label btn-success">正常</span>
                                    </a>&ndash;&gt;
                                    <a href="<?php echo U('Service/serviceedit',array('id'=>$vo['serviceid']));?>">
                                        <span class="label btn-primary"> 修改</span>
                                    </a>
                                    <a href="<?php echo U('Service/Servicedel',array('id'=>$vo['id']));?>">
                                        <span class="label btn-danger">删除</span>
                                    </a>
                                    &lt;!&ndash;  <a href="<?php echo U('User/doctoredit',array('id'=>$vo['id']));?>">
                                         <span class="label btn-primary">编辑</span>
                                     </a> &ndash;&gt;
                                </td>-->
                                <td class="">
                                    <a href="<?php echo U('Service/servicestatus',array('id'=>$vo['id'],'type'=> 1));?>">
                                        <span class="label btn-warning">冻结</span>
                                    </a>

                                    <a href="<?php echo U('Service/servicestatus',array('id'=>$vo['id'],'type'=> 2));?>">
                                        <span class="label btn-success">正常</span>
                                    </a>
                                    <a href="<?php echo U('Service/Servicedel',array('id'=>$vo['id']));?>">
                                        <span class="label btn-danger">删除</span>
