                    ...
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 pull-right">
                        <form class="form-horizontal" method="post" id="user-editor" enctype="multipart/form-data" action="<?php echo U('User/index');?>">
                            <div class="row form-group">
                                ...
                                <!--    <a href="<?php echo U('Service/servicelist');?>">  <button type="button" class="btn btn-primary">返回预约设置</button></a>-->
                ...
                <div class="row">
                    <table class="table table-bordered">
                        <tr class="text-left" style="">
                            <!--<td class="active" colspan="2">价格</td>-->
                            <td class="active" colspan="2" style="padding-left: 30px;">价格: <span style="color:red;padding-left: 10px;">&nbsp;&nbsp;&nbsp;<?php echo ($price); ?>元</td>
                            <td class="active" colspan="2"  style="padding-left: 30px;">人数: <span style="color:red;padding-left: 10px;">&nbsp;&nbsp;&nbsp;<?php echo ($renshu); ?>人</td>

                        </tr>
                        <tr class="active text-center" style="font-weight: bolder">
                            <td class="active">日期</td>
                            <td class="active" >早</td>
                            <td class="active">中</td>
                            <td class="active">晚</td>
                        </tr>
                        <?php if(is_array($info)): foreach($info as $k=>$vo): ?><tr class="active text-center">
                                <td class="active" style="font-weight: bolder">
                                    <?php echo ($k); ?>
                                </td>
                                <?php if($vo[0]['week']): ?><td class="active" style="color:red">预约</td>
                                    <?php else: ?>
                                    <td class="active"></td><?php endif; ?>
                                <?php if($vo[1]['week']): ?><td class="active" style="color:red">预约</td>
                                    <?php else: ?>
                                    <td class="active"></td><?php endif; ?>
                                <?php if($vo[2]['week']): ?><td class="active" style="color:red">预约</td>
                                    <?php else: ?>
                                    <td class="active"></td><?php endif; ?>
