            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12  shop_right">
                <div class="row">
                    ...
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 pull-right">
                        <a href="<?php echo U('Admin/index');?>"> <button type="button" class="btn btn-primary">返回列表</button> </a>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 shop_list">
                <div class="row">
                    <form action='/public_html/index.php/Admin/Admin/editManager/id/8.html' method="post" id="form02" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="text-center">
                          ...
                          <td class="active"><input type="password" name="password" value="" placeholder="默认空则不修改"/></td>
                        </tr>
                        <tr class="text-center">
                            <td class="active">选择角色：</td>
                            <td class="active">
                                <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="radio-inline">
                                        <?php if($info['role_id'] == $vo['id']): ?><input type="radio" name="role_id" value="<?php echo ($vo["id"]); ?>" class="demo01" checked /> <?php echo ($vo["rolename"]); ?>
                                            <?php else: ?>
                                            <input type="radio" name="role_id" value="<?php echo ($vo["id"]); ?>" class="demo01"  /> <?php echo ($vo["rolename"]); endif; ?>
