                    ...
                    <form class="form-horizontal" method="post" id="user-editor" enctype="multipart/form-data" action="<?php echo U('Sick/searchsick');?>">
                        <div class="row form-group">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <a href="<?php echo U('Admin/authadd');?>">  <button type="button" class="btn btn-primary">添加权限</button></a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row">
                <table class="table table-bordered">
                    <tr class="text-center">
                        ...
                        <td class="active">权限名</td>
                        <td class="active">路径</td>
                        <td class="active">父ID</td>
                    ...
                    <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-center">
                            ...
                            <td class="active"><?php echo ($vo["title"]); ?></td>
                            <td class="active text-left"><?php echo (str_repeat($ge,$vo['level'])); echo ($vo["auth_path"]); ?></td>
                            <td class="active"><?php echo ($vo["p_id"]); ?></td>
                            <td class="active"><?php echo ($vo["level"]); ?></td>
                            <td class="active"><?php echo ($vo["is_statu"]); ?></td>
                            <td class="active">
                                ...
                                <a href="<?php echo U('Admin/delete',array('id'=>$vo['id']));?>">
                                    <span class="label btn-danger">删除</span>
                                </a>
                                <a href="<?php echo U('Admin/editor',array('id'=>$vo['id']));?>">
