    ...
    <div id="mws-container" class="clearfix">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 shop_list">
                <div class="row">
                    <form action='/public_html/index.php/Admin/Admin/roleadd.html' method="post" id="form02" enctype="multipart/form-data">
                    <table class="table table-bordered">
                        ...
                        <tr class="">
                          ...
                          <td class="active"><input type="text" name="rolename" /></td>
                        </tr>
                        <tr class="text-left">
                            ...
                            <td class="active">
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="radio-inline">
                                        <input type="checkbox" name="auth_all_ids[]" value="<?php echo ($vo["id"]); ?>" class="demo01"> <?php echo ($vo["title"]); ?>
