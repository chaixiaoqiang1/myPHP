                      ...
                      <!--  <form class="form-horizontal" method="post" id="user-editor" enctype="multipart/form-data" action="<?php echo U('User/index');?>">
                            <div class="row form-group">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <a href="<?php echo U('Service/servicelist');?>">  <button type="button" class="btn btn-primary">返回服务列表</button></a>
                ...
                <div class="row">
                    <table class="table table-bordered">
                        <tr class="text-center">
                            ...
                            <!--<td class="active">是否开启</td>-->
                            <!--<td class="active">价钱</td>-->
                          <!--  <td class="active">复诊券</td>
                            <td class="active">复诊券折扣</td>-->
                        ...
                        <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-center">
                                ...
                                <!--<td class="info">
                                    <?php if($vo['is_open'] == 1): ?><p style="color:greenyellow">已开启</p>
                                    <?php else: ?>
                                        <p style="color:red">未开启</p><?php endif; ?>
                                </td>-->
                                <td class="">
                                    <?php echo ($vo["s_id"]); ?>
                                </td>
                               <!-- <td class="info">
                                    <?php if($vo['is_ticket'] == 1): ?><p style="color:greenyellow">已开启</p>
                                        <?php else: ?>
                                            <p style="color:red">未开启</p><?php endif; ?>
                                </td>-->
                               <!-- <td class="info">
                                    <?php echo ($vo["ticketdiscount"]); ?>
                                </td>-->
                                <td class="" >
                                    <a href="<?php echo U('Service/liaotian',array('fid'=>$vo['id'],'did'=> $vo['d_id']));?>">
                                    <button class="btn btn-success" >点击查看</button>
                                    </a>
                                </td>

                                <td class="">
                                    <?php if($vo['is_pay'] == 2): ?><span style="color: green;">已支付</span>
                                        <?php else: ?>
                           ...
                           <!--     <td class="info">
                                        <a href="<?php echo U('Service/imagetextstatus',array('id'=>$vo['id']));?>">
                                        ...
                                        <a href="<?php echo U('Service/imagetextedit',array('id'=>$vo['id']));?>">
                                            <span class="label btn-primary"> 修改</span>
                                        </a>
                                        <a href="<?php echo U('Service/imagetextdel',array('id'=>$vo['id']));?>">
