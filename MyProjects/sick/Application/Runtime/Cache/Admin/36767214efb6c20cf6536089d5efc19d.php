...
&lt;!&ndash;                                    <button>添加数据</button>&ndash;&gt;

 <a href="<?php echo U('Sick/index');?>"> <button type="button" class="btn btn-primary">返回列表</button> </a>
                                </div>
                            </div>
                        </form>
                    </div>-->
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 shop_list">
                <div class="row">
                    <form action='/public_html/index.php/Admin/Sick/saveUser/id/1.html' method="post" >
                        
                    <table class="table table-bordered">
                        <tr class="text-center">
                          <td class="active">用户名</td>
                          <td class="active"><input type="text" name="username" value="<?php echo ($data['username']); ?>" /></td>
                        </tr>
                        
                        <tr class="text-center">
                          <td class="active">电话号</td>
                          <td class="active"><input type="text" name="phonenum" value="<?php echo ($data['phonenum']); ?>" /></td>
                        </tr>
                        ...
                        <tr class="text-center">
                          ...
                          <td class="active"><input type="text" name="height" value="<?php echo ($data['height']); ?>" /></td>
                        </tr>
                        
                         <tr class="text-center">
                          <td class="active">年龄</td>
                          <td class="active"><input type="text" name="userage" value="<?php echo ($data['userage']); ?>" /></td>
                        </tr>
                        
                        <tr class="text-center">
                          <td class="active">体重</td>
                          <td class="active"><input type="text" name="weight" value="<?php echo ($data['weight']); ?>" /></td>
                        </tr>
                        
                        <tr class="text-center">
                          <td class="active">地址</td>
                          <td class="active"><input type="text" name="address" value="<?php echo ($data['address']); ?>" /></td>
                        </tr>
                        
                        
                    <tr class="text-center">
                         <td><input type='submit' value='提交'></td>
                         <td><a href='<?php echo U("Sick/index");?>' >返回列表</a></td>
                    </tr>
