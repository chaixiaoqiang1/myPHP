                    ...
                    <form class="form-horizontal" method="post" id="user-editor" enctype="multipart/form-data" action="<?php echo U('Sick/searchsick');?>">
                        <div class="row form-group">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <a href="<?php echo U('Admin/roleadd');?>">  <button type="button" class="btn btn-primary">添加角色</button></a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row">
                <table class="table table-bordered">
                    <tr class="text-center">
                        ...
                        <td class="active">角色权限</td>
                        <!--<td class="active">状态</td>-->
                        <td class="active">操作</td>
                    </tr>

                    <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-left">
                            <td class="active"><?php echo ($vo["id"]); ?></td>
                            <td class="active"><?php echo ($vo["rolename"]); ?></td>

                            <td class="active">
                                <?php if(is_array($vo['auth_all_ids'])): $i = 0; $__LIST__ = $vo['auth_all_ids'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i; echo ($v1["title"]); ?>&nbsp;|&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
                            </td>
                            <td class="active">
                              <!--  <a href="<?php echo U('Admin/status',array('id'=>$vo['id']));?>">
                                ...
                                <a href="<?php echo U('Admin/roledel',array('id'=>$vo['id']));?>">
                                    <span class="label btn-danger">删除</span>
                                </a>
                                <a href="<?php echo U('Admin/roleedit',array('id'=>$vo['id']));?>">
