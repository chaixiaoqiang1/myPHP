        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 shop_right">
            <div class="row">
                ...
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 pull-right">
                    <form class="form-horizontal" method="post" id="user-editor" enctype="multipart/form-data" action="<?php echo U('Sick/searchsick');?>">
                        <div class="row form-group">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <!--      <p><input class="shop_search_input" placeholder="输入用户名关键字" name="username" type="text"> <button>搜索</button></p>-->
                                <a href="<?php echo U('Admin/addManager');?>">  <button type="button" class="btn btn-primary">添加管理员</button></a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row">
                <table class="table table-bordered">
                    <tr class="text-center">
                        ...
                        <td class="active">拥有权限</td>
                        <td class="active">操作</td>
                    </tr>
                    <?php if(is_array($admin_list)): foreach($admin_list as $k=>$vo): ?><tr class="text-center">
                            <td class="active"><?php echo ($vo["id"]); ?></td>
                            <td class="active"><?php echo ($vo["username"]); ?></td>
                            <td class="active">
                                <?php if($vo['role_id'] != 0): if(is_array($vo['role_id'])): $i = 0; $__LIST__ = $vo['role_id'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i; echo ($v1["title"]); ?>&nbsp;|&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
                                    <?php else: ?>
                                    所有权限<?php endif; ?>
                            </td>
                            <td class="active">
                                <?php if($vo['id'] != 1): ?><!-- <a href="<?php echo U('Admin/status',array('id'=>$vo['id']));?>">
                                    ...
                                    <a href="<?php echo U('Admin/delManager',array('id'=>$vo['id']));?>">
                                        <span class="label btn-danger">删除</span>
                                    </a>

                                    <a href="<?php echo U('Admin/editManager',array('id'=>$vo['id']));?>">
                                        <span class="label btn-info">修改</span>
                                    </a><?php endif; ?>
                            </td>
                        </tr>
