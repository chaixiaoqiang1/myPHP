...
<div id="mws-sidebar">
    ...
    <form class="form-horizontal" method="post" action="<?php echo U('Message/doaddclass');?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-lg-4">
                 <input type="number" min='0' class="form-control" value="<?php echo ($data["sort"]); ?>" name="displayorder"/>
            </div>
            <span class="col-lg-6 height-center"></span>
        </div>
