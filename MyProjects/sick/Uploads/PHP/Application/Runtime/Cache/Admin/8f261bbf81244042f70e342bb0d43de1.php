...
<div id="mws-sidebar">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="border-bottom white-bg dashboard-header">
            <div>
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <p style="font-size: 20px; margin-top: 25px;"><button type="button" class="btn btn-default">分类管理</button></p>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="margin-top: 20px;">
                        <a href="<?php echo U('User/specialtyadd');?>">
            ...
            <div class="col-md-4 col-lg-12" style="border:1px solid #eeeeee; padding-top: 20px; margin-top: 10px;">
                <table class="table table-hover table-mail">
                    ...
                    <tr level="1">
                        <th>分类ID</th>
                        <th>分类名称</th>
                        <!--<th style="text-align: center;">医生列表</th>-->
                        <th width="60">操作</th>
                    </tr>
                    
                   <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr level="1">
                        
                        <td><?php echo ($vo["id"]); ?></td>
                        <td><?php echo ($vo["catname"]); ?></td>
                        <!--<td></td>-->
                        <td><a href="<?php echo U('User/specialtyedit',array('id'=> $vo['id']));?>"><span class="label btn-warning">修改</span></a>&nbsp;&nbsp;</a> <a href="<?php echo U('User/specialtydel',array('id'=> $vo['id']));?>"><span class="label btn-danger" >删除</span></a>&nbsp;&nbsp;</a></td>
