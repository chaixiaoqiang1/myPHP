...
<div id="mws-sidebar">
    ...
    <form class="form-horizontal" method="post" action="<?php echo U('Message/addInfo');?>" enctype="multipart/form-data">
        <div class="form-group" style="margin-top: 50px;">
            <label class="col-lg-2 control-label">选择分类:</label>
            <div class="col-lg-4">
                <select class="form-control" name="pid">
                  <!--   <option selected value="0">顶级分类</option> -->
                    <?php if(is_array($category)): foreach($category as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; ?>
                </select>
            </div>
            <span class="col-lg-6 height-center"></span>
        </div>
        <div class="form-group">
            <label class="col-lg-2 control-label">资讯标题:</label>
            <div class="col-lg-4">
                <input type="text"  class="form-control" name="infoname" required>
            </div>
            <span class="col-lg-6 height-center"></span>
        </div>

         <div class="form-group">
            <label class="col-lg-2 control-label">排序值:</label>
            <div class="col-lg-4">
                 <input type="number" min='0' class="form-control" value="<?php echo ($data["displayorder"]); ?>" name="displayorder"/>
            </div>
            <span class="col-lg-6 height-center"></span>
        </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-4">
                    ...
                    <label class="radio-inline">
                        <input type="radio"  checked value="1"  name="status">不启用
                    </label>
            </div>
            <span class="col-lg-6 height-center"></span>
        </div>
        <div class="form-group">
            <label class="col-lg-2 control-label">资讯内容:</label>
            <div class="col-lg-4">
               <script id="editor" name='content' type="text/plain" style="width:780px;height:350px;"></script>
            </div>
...
<?php if($_SESSION['admin_id']== 1): ?><script>
    ...
    <script type="text/javascript" charset="utf-8" src="/taiyou/Public/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/taiyou/Public/ueditor/ueditor.all.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="/taiyou/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
