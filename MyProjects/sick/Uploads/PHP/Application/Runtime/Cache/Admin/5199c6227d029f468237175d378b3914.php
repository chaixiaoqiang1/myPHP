...
<div id="mws-sidebar">
        ...
        <div>
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <p style="font-size: 20px; margin-top: 25px;">添加分类</p>
                </div>
    ...
    <form class="form-horizontal" method="post" action="/taiyou/index.php/Admin/User/specialtyadd.html" enctype="multipart/form-data">
