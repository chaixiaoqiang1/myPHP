        ...
        <div class="row">
            <div class="text-center">
                ...
                <p class="shop_right_color pull-right" style='padding-right:100px;'>
                    <a style="color:#fff;" href="<?php echo U('Activity/addactivity');?>">添加活动</a>
                </p>
            </div>
        </div>
        ...
        <div class="row shop_list">
            <table class="table table-bordered">
                <tr class="text-center">
                    <td style='width:400px;' class="active">活动标题</td>
                    <td class="active">排序值</td>
                    <td class="active">添加时间</td>
                    <td class="active">状态</td>
                    <td class="active">操作</td>
                </tr>
                <?php if(is_array($data)): foreach($data as $k=>$vo): if(($k%2) == 0): ?><tr class="text-center">
                        <td class="info" style="width: 180px;overflow: hidden;white-space: nowrap;   text-overflow: ellipsis;">
                            <?php echo ($vo["name"]); ?>
                        </td>
                        <td class="info"><?php echo ($vo["displayorder"]); ?></td>
                        <td style='width:200px;' class="info"><?php echo (date("y-m-d h:i:s",$vo["createtime"])); ?></td>
                        <td class="info">
                   ...
                   <?php else: ?>
                       <tr class="text-center">
                            ...
                            <td class="active"><?php echo ($vo["displayorder"]); ?></td>
                            <td style='width:200px;' class="active"><?php echo (date("y-m-d h:i:s",$vo["createtime"])); ?></td>
                            <td class="active">
                                <?php if($vo['status'] == 1): ?>禁用
                                    <?php else: ?>
                                    启用<?php endif; ?>
