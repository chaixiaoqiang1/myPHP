            ...
            <div>
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <p style="font-size: 20px; margin-top: 25px;">修改分类</p>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="margin-top: 20px;">
                        <a href="<?php echo U('User/specialtylist');?>">
                            <!--<button type="button" class="btn btn-default pull-right issued_pro">添加分类</button>-->
                            <button type="button" class="btn btn-primary">分类列表</button>
                        </a>
                    </div>
                </div>
            </div>
    </div>
    <form class="form-horizontal" method="post" action="/taiyou/index.php/Admin/User/specialtyedit/id/2.html" enctype="multipart/form-data">
        <div class="form-group" style="margin-top: 50px;">
            <!--<label class="col-lg-2 control-label">选择分类:</label>-->
            <!--<div class="col-lg-4">
                <select class="form-control" name="pid">
                    <option selected value="0">顶级分类</option>
                    <?php if(is_array($category)): foreach($category as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["cate_name"]); ?></option><?php endforeach; endif; ?>
                </select>
            </div>-->
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text"  class="form-control" name="catname" required value="<?php echo ($info["catname"]); ?>">
            </div>
            <span class="col-lg-6 height-center"></span>
        </div>
        <div class="form-group">
