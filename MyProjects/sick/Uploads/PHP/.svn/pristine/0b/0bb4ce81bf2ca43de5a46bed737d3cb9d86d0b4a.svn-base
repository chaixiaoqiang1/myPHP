...
<!--                                    <button>添加数据</button>-->
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 shop_list">
                <div class="row">
                    <form action='/taiyou/index.php/Admin/User/add.html' method="post" enctype="multipart/form-data" >
                    ...
                    <table class="table table-bordered">
                       ...
                       <tr class="text-center">
                          ...
                          <td class="active">
                              ...
                              <select name="office">
                                  <?php if(is_array($keshi)): $i = 0; $__LIST__ = $keshi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["catname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                              </select>
