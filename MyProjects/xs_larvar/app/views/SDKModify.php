...
function getSDKController($scope, $http, alertService,$modal, $filter) {
    $scope.alerts = [];
    ...
    $scope.processFrom = function(check) {
        ...
        $http({
            'method': 'post',
            'url': '/slave-api/mobilegame/sdkmodify',
...
<div class="col-xs-12" ng-controller="getSDKController">
    <form action="/slave-api/mobilegame/sdkmodify" method="post" role="form"
...
<script type="text/ng-template" id="modify_data.html">
        ...
        <form action="/slave-api/mobilegame/modifydata" method="post" role="form" ng-submit="modifyForm('/slave-api/mobilegame/modifydata')" onsubmit="return false;">
