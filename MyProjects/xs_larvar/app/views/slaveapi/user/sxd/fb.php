<script> 
function SXDGetFBStatController($scope, $http, alertService, $filter) {
    $scope.alerts = [];
    $scope.formData = {};
    $scope.items = {};
...
<div class="col-xs-12" ng-controller="SXDGetFBStatController">
	<div class="row">
		<div class="eb-content">
			<form action="/slave-api/user/sxd/fb" method="get" role="form"
				ng-submit="processFrom('/slave-api/user/sxd/fb')"
