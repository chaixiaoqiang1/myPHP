...
<div class="col-xs-12" ng-controller="queryChip">
	<div class="row">
		<div class="eb-content">
			...
			<div class="col-md-4" style="padding: 0">
				<input type='button' class="btn btn-primary"
					value="<?php echo '查询' ?>"
					ng-click="process('/game-server-api/poker/queryPoker')" />
			</div>
				...
				<table class="table table-striped">
					...
					<tbody>
						<tr ng-repeat='t in items'>
							<td>{{t.GAME_TYPE}}	</td>
							<td>{{t.BLIND}}</td>
							<td>{{t.COUNT_GAME_ID}}</td>
							<td>{{t.COUNT_PLAYER_ID}}</td>
							<td>{{t.sum_table_fee_player_num}}</td>
						</tr>
					</tbody>
