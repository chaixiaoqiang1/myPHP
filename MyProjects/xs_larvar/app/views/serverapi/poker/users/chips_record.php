<script>
	function PokerChipsRecordController($http, $scope, alertService, $filter){
		$scope.alerts = [];
		$scope.formData = {};
		$scope.items = [];
		...
		$scope.process = function(newPage){
			...
			$http({
				'method' : 'post',
				'url' : '/game-server-api/poker/chips_record?page=' + newPage,
...
<div class="col-xs-12" ng-controller="PokerChipsRecordController">
	<div class="row">
