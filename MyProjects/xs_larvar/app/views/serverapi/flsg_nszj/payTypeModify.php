        ...
        <div class="eb-content">
            <form name="myForm" method="post" role="form" ng-submit="processFrom('/mobile_paytype/update')" onsubmit="return false;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id" ng-init="formData.id='<?php echo $type['id']?>'" disabled="true" required ng-model="formData.id" name="id"/>
                </div>

                <div class="form-group">
                    <label for="platform_primary_key">platform_primary_key</label>
                    <input type="text" class="form-control" id="platform_primary_key" ng-init="formData.platform_primary_key='<?php echo $type['platform_primary_key']?>'" disabled="true" required ng-model="formData.platform_primary_key" name="platform_primary_key"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pay_lib" ng-init="formData.pay_lib='<?php echo $type['pay_lib']?>'"  ng-model="formData.pay_lib" name="pay_lib"/>
                </div>
