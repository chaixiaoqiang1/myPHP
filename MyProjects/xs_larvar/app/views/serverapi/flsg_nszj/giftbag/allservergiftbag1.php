...
<div class="col-xs-12" ng-controller="sendAllServerGiftBagController1">
			...
			<form action="/game-server-api/gift-bag/all-server-gift-bag1"
				...
				<div class="form-group">
					<select class="form-control" name="gift_bag_id" id="gift_bag_id"
						...
						<option value="<?php echo $v->itemid?>"><?php echo $v->itemid . ':' . $v->name;?></option>
						<?php } ?>		
					</select>
				</div>
				<div class="form-group">
					<input type="text" class="form-control"
						...
						ng-model="formData.days" required name="days"?>
				</div>
				<div class="form-group">
	...
	<div class="row margin-top-10">
		<div class="eb-content">
			...
			<div class="col-md-4">
				<a href="/game-server-api/giftbag/lookuppage?app_id=193" target="_blank"><?php echo Lang::get('serverapi.search_gift_record')?></a>
			</div>
		</div>
	</div>
</div>