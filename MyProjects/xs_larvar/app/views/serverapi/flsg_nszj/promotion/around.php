...
<div class="col-xs-12" ng-controller="turnplateController">
	<div class="row">
		<div class="eb-content" style="width: 60%; min-width: 300px; background-color:#F0FFFF ;">
			...
			<div class="form-group">
				<select class="form-control" name="turnplate_type" ng-model="formData.turnplate_type"
					 ng-init="formData.turnplate_type=1">
					 <?php if('nszj' == $game_code){ ?>
						<option value="1"><?php echo Lang::get('serverapi.ns_around')?></option>
					<?php }elseif('flsg' == $game_code){?>
						<option value="1"><?php echo Lang::get('serverapi.gold')?></option>
					<?php }?>
				</select>
			</div>
			<div class="form-group" style="height: 40px;">
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						...
						ng-click="process('/game-server-api/promotion/around/open')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						value="<?php echo Lang::get('serverapi.promotion_lookup') ?>"
						ng-click="lookup('/game-server-api/promotion/around/lookup')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-danger"
						value="<?php echo Lang::get('serverapi.promotion_close') ?>"
						ng-click="process('/game-server-api/promotion/around/close')" />
				</div>
			</div>
