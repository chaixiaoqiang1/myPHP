<script>
	function addPromotionNSController($scope, $http, alertService, $filter) {
		$scope.alerts = [];
...
<div class="col-xs-12" ng-controller="addPromotionNSController">
	<div class="row">
		<div class="eb-content">
			...
			<div class="form-group">
				<label><input type="checkbox" name="promotion_type" value="1"
					ng-model="formData.promotion_type1" /><?php echo Lang::get('serverapi.promotion_longchuang') ?></label>
				<label><input type="checkbox" name="promotion_type" value="2"
					ng-model="formData.promotion_type2" /><?php echo Lang::get('serverapi.promotion_tili') ?></label>
				<label><input type="checkbox" name="promotion_type" value="5"
					ng-model="formData.promotion_type5" /><?php echo Lang::get('serverapi.promotion_month_card') ?></label>
			</div>
			<div class="form-group" style="height: 40px;">
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						value="<?php echo Lang::get('serverapi.promotion_set') ?>"
						ng-click="process('/game-server-api/promotion_ns')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						value="<?php echo Lang::get('serverapi.promotion_lookup') ?>"
						ng-click="lookup('/game-server-api/promotion_ns/lookup')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-danger"
						value="<?php echo Lang::get('serverapi.promotion_close') ?>"
						ng-click="process('/game-server-api/promotion_ns/close')" />
				</div>
			</div>
		</div>
	</div>
