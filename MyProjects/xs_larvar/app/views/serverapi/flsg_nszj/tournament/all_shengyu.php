<script>
	function allTournamentController($scope, $http, alertService, $filter) {
		$scope.alerts = [];
		$scope.formData = {};
		$scope.formData.is_all = 1;/*1代表全服圣域争霸*/
...
<div class="col-xs-12" ng-controller="allTournamentController">
	<div class="row">
		<div class="eb-content">
			...
			<div class="form-group" style="height: 30px;">
				<span style = "color:red; font-size:16px">全服圣域争霸的开启和查看操作和圣域争霸的操作一样</span>
			</div>
			...
			<div class="form-group" style="height: 40px;">
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						...
						ng-click="process('/game-server-api/nszj/all_shengyu')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						value="<?php echo Lang::get('serverapi.shengyu_lookup') ?>"
						ng-click="lookup('/game-server-api/nszj/all_shengyu/lookup')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-danger"
						value="关闭全服圣域争霸"
						ng-click="close('/game-server-api/nszj/all_shengyu/close')" />
				</div>
			</div>
		</div>
	</div>
