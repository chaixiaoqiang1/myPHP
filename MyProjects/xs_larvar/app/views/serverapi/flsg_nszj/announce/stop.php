...
function stopAnnouceController($scope, $http, alertService)
{
	$scope.alerts = [];
	$scope.formData = {};
...
<div class="col-xs-12" ng-controller="stopAnnouceController">
	<div class="row" >
				...
				<div class="form-group" style="height: 40px;">
					<div class="col-md-4" style="padding: 0">
						<input type='button' class="btn btn-primary"
							...
							ng-click="processFrom('/game-server-api/level/stop-announce?action=true')" />
					</div>
					<div class="col-md-4" style="padding: 0">
						<input type='button' class="btn btn-danger"
							value="<?php echo Lang::get('serverapi.close_stop') ?>"
							ng-click="processFrom('/game-server-api/level/stop-announce?action=false')" />
					</div>
					<div class="col-md-4" style="padding: 0">
						<input type='button' class="btn btn-primary"
							value="<?php echo Lang::get('serverapi.lookup_stop') ?>"
							ng-click="lookup('/game-server-api/level/stop-announce/look')" />
					</div>
			    </div>	
			</form>	 
		</div><!-- /.col -->
