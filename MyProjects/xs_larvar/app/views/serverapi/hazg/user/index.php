<script type="text/javascript">
	function HAZGGetPlatformUserController($scope, $http, alertService) {
		$scope.alerts = [];
		$scope.formData = {};
		$scope.user = {};
...
<div class="col-xs-12" ng-controller="SXDGetPlatformUserController">
	<div class="row">
		<div class="eb-content">
			<form action="/game-server-api/user/th" method="post" role="form"
				ng-submit="processFrom('/game-server-api/user/th')"
