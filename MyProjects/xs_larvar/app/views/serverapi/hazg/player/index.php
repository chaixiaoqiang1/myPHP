...
function THSearchServerPlayerController($scope, $http, alertService)
{
	$scope.alerts = [];
	$scope.formData = {};
	$scope.players = [];
...
<div class="col-xs-12" ng-controller="THSearchServerPlayerController">
	<div class="row">
		<div class="eb-content">
			<form action="/game-server-api/th/player" method="post" role="form"
				ng-submit="processFrom('/game-server-api/th/player')"
