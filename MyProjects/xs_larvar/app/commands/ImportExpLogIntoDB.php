...
class ImportExpLogIntoDB extends Command {

	 const TABLE_NAME = 'log_exp';

    const FILE_KEY = 'ExpLog';
     ...
     * @var string
     */
    protected $description = 'Import Exp Log.';
    ...
    private function loadExpFile()
    {
        ...
        Log::info('Import ' . $this->db_name . ' Exp Log');
        try
        {
