        ...
        link: function(scope, element, attrs, ngModelCtrl) {
          ...
          scope.selectDate = function(date, closeCalendar) {
			...
			if (typeof(ngModelCtrl.$viewValue) == 'string') {
				var tmpDate = parseDateString(ngModelCtrl.$viewValue);
				ngModelCtrl.$viewValue = tmpDate;
			};
			...
			var tmpNeedDate = $filter('date')(date, 'yyyy-MM-dd');
			date = parseDateString(tmpNeedDate + ' ' + scope.inputTime);
