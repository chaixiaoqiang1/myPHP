<script>
	function treasureShopController($scope, $http, alertService, $filter) {
		$scope.alerts = [];
...
<div class="col-xs-12" ng-controller="treasureShopController">
	<div class="row">
			...
			<div class="form-group" style="height: 40px;">
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						...
						ng-click="process('/game-server-api/promotion/shop-open')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						value="<?php echo Lang::get('serverapi.promotion_lookup') ?>"
						ng-click="lookup('/game-server-api/promotion/shop-lookup')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-danger"
						value="<?php echo Lang::get('serverapi.promotion_close') ?>"
						ng-click="process('/game-server-api/promotion/shop-close')" />
				</div>
			</div>
