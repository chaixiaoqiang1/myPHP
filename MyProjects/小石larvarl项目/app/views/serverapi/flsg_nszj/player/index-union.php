<script type="text/javascript">
	function searchServerPlayerUnionController($scope, $http, alertService)
	{
		$scope.alerts = [];
		$scope.formData = {};
		$scope.players = [];
...
<div class="col-xs-12" ng-controller="searchServerPlayerUnionController">
	<div class="row">
		<div class="eb-content">
			<form action="/game-server-api/player/union" method="post" role="form"
				ng-submit="processFrom('/game-server-api/player/union')"
				...
				<div class="form-group">
					<select class="form-control" name="server_id1"
						...
						<option value="0"><?php echo Lang::get('player.player_chief_server') ?></option>
					...
					<select class="form-control" name="server_id2"
						...
						ng-init="formData.server_id2=0 " style="width:50%">
						<option value="0"><?php echo Lang::get('player.player_vice_server') ?></option>
