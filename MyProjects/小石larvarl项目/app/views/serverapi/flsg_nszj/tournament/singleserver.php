		...
		<div class="eb-content">
			...
			<div class="form-group" style="height: 40px;">
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						...
						ng-click="process('/game-server-api/tournament/single-server')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						value="<?php echo Lang::get('serverapi.tournament_update') ?>"
						ng-click="process('/game-server-api/tournament/single-server/update')" />
				</div>
				<div class="col-md-4" style="padding: 0">
					<input type='button' class="btn btn-primary"
						value="<?php echo Lang::get('serverapi.tournament_load') ?>"
						ng-click="process('/game-server-api/tournament/single-server/load')" />
				</div>
			</div>
			...
			<div class="col-md-4" style="padding: 0">
				<input type="button" class="btn btn-danger"
					...
					ng-click="process('/game-server-api/tournament/single-server/close')" />
			</div>
		</div>
	</div>
