<script>
	function updateLevelController($scope, $http, alertService) {
		$scope.alerts = [];
		$scope.formData = {};
...
<div class="col-xs-12" ng-controller="updateLevelController">
	<div class="row">
		<div class="eb-content">
			<form action="/game-server-api/update-level" method="post"
				role="form"
				ng-submit="processFrom('/game-server-api/update-level')"
				...
				<div class="form-group" style="height: 30px;">
					...
					<div class="col-md-6" style="padding: 2">
						<input type="text" class="form-control" ng-model="formData.new_level"
							name="new_level"
							placeholder="<?php echo Lang::get('serverapi.enter_new_level') ?>" />
					</div>
				</div>
				<div class="clearfix">
					<br />
