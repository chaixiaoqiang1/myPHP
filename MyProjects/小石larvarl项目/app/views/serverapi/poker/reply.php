<script>
	function getGMRepliedController($scope, $http, $filter, alertService) {
		...
		$scope.processFrom = function(newPage) {
			...
			$http({
				'method' : 'post',
				'url'	 : '/game-server-api/poker/replied?page=' + newPage,
...
<div class="col-xs-12" ng-controller="getGMRepliedController">
	<div class="row" id="top">
		<div class="eb-content">
			<form action="/game-server-api/gm/replied" method="get" role="form" ng-submit="processFrom(1)" onsubmit="return false;">
				<div class="form-group">
					<input type="text" class="form-control" id="player_name" placeholder="<?php echo Lang::get('slave.enter_player_name') ?>" ng-model="formData.player_name" name="player_name" />
				</div>
				<div class="form-group">
