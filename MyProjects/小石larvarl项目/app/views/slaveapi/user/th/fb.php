<script> 
function THGetFBStatController($scope, $http, alertService, $filter) {
    $scope.alerts = [];
    $scope.formData = {};
    $scope.items = {};
...
<div class="col-xs-12" ng-controller="THGetFBStatController">
	<div class="row">
		<div class="eb-content">
			<form action="/slave-api/user/sxd/fb" method="get" role="form"
				ng-submit="processFrom('/slave-api/user/th/fb')"
