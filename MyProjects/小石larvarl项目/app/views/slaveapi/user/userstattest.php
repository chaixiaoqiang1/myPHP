		...
		<div class="eb-content">
			<form action="/slave-api/user/userstat" method="get" role="form"
				...
				<br>
					<b>
						<ul>
							<li><?php echo Lang::get('slave.userstat_note'); ?></li>
							<li><?php echo Lang::get('slave.tr_summer_time'); ?></li>
							<li><?php echo Lang::get('slave.br_summer_time'); ?></li>
						</ul>
					</b>
				</div>
			</form>
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<dl class="dl-horizontal">
					...
					<dt><?php echo Lang::get('slave.sum_anonymous_formal_player_create')?></dt>
					<dd>{{sum.sum_player_anonymous_formal}}</dd>
					...
					<dt><?php echo Lang::get('slave.sum_anonymous_formal_level10_player_create')?></dt>
					<dd>{{sum.sum_lev_anonymous_formal}}</dd>
				</dl>
			</div>
		</div>
	</div>
		...
		<table class="table table-striped">
			<thead>
				<tr class="info">
					...
					<td><?php echo Lang::get("slave.formal_create_rate");?></td>
					<td><?php echo Lang::get("slave.anonymous_create");?></td>
					<td><?php echo Lang::get("slave.anonymous_create_rate");?></td>
					<td><?php echo Lang::get("slave.formal_level10_create");?></td>
					<td><?php echo Lang::get("slave.formal_level10_create_rate");?></td>
					<td><?php echo Lang::get("slave.anonymous_level10_create");?></td>
					<td><?php echo Lang::get("slave.anonymous_level10_create_rate");?></td>
				</tr>
			</thead>
			<tbody>
				<tr ng-repeat="t in items">
					...
					<td>{{t.count_player_formal}}</td>
					<td ng-if="t.count_player_formal>0">{{t.count_player_formal/t.count_formal*100| number:2}}%</td>
					<td ng-if="t.count_player_formal <= 0">0%</td>
					<td>{{t.count_player_anonymous}}</td>
					<td ng-if="t.count_player_anonymous > 0">{{t.count_player_anonymous/t.count_anonymous*100| number:2}}%</td>
					<td ng-if="t.count_player_anonymous <= 0">0%</td>
					<td>{{t.count_lev_formal}}</td>
					<td ng-if="t.count_lev_formal > 0">{{t.count_lev_formal/t.count_player_formal*100| number:2}}%</td>
					<td ng-if="t.count_lev_formal <= 0">0%</td>
					<td>{{t.count_lev_anonymous}}</td>
					<td ng-if="t.count_lev_anonymous > 0">{{t.count_lev_anonymous/t.count_player_anonymous*100| number:2}}%</td>
					<td ng-if="t.count_lev_anonymous <= 0">0%</td>
				</tr>
