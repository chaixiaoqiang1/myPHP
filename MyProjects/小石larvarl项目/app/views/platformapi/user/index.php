<div class="col-xs-12" ng-controller="getPlatformUserController">
	<div class="row">
		...
		<table class="table table-striped">
			<thead>
				<tr class="info">
					...
					<td><b><?php echo Lang::get('player.first_recharge_level');?></b></td>
					<td><b><?php echo Lang::get('player.last_login');?></b></td>
					<td><b><?php echo Lang::get('player.active');?></b></td>
					<td><b><?php echo Lang::get('player.is_online');?></b></td>
					<td><b><?php echo Lang::get('player.level');?></b></td>
					<td><b><?php echo Lang::get('player.vip_level');?></b></td>
					<td><b><?php echo Lang::get('player.rank');?></b></td>
					<td><b><?php echo Lang::get('player.league_name');?></b></td>
					<td><b><?php echo Lang::get('player.tili');?></b></td>
					<td><b><?php echo Lang::get('player.yuanbao');?></b></td>
					<td><b><?php echo Lang::get('player.tongqian');?></b></td>
					<td><b><?php echo Lang::get('player.tp_user_id');?></b></td>
				</tr>
			</thead>
			<tbody>
