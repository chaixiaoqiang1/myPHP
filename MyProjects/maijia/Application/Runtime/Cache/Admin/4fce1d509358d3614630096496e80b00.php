        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">课程信息查看</span></li>
                    <li class="active" id="parentIframe"><span class="parentIframe iframeurl"></span></li>
                    <li class="active" id="parentIfour"><span class="parentIfour iframeurl"></span></li>
                </ul>
            </div>

                <div class="h_products_list clearfix" id="products_list" style="padding-top: 20px;">
                    <div class="table_menu_list " id="wd">
                            <div class="row" style="margin-bottom: 20px;">
                                <div class="col-lg-12 col-md-12 col-sm-12"><h4>
                                    <lable  class="col-sm-2  no-padding-right" >用户名:</lable>
                                    <div class="col-sm-9" style="padding: 5px;"><?php echo ($info["user_id"]); ?></div>
                                    </h4> </div>
                            </div>
                            <div class="row" style="margin-bottom: 20px; ">
                                <div class="col-lg-12 col-md-12 col-sm-12"><h5>
                                    <label  class="col-sm-2  no-padding-right"> 内容: </label>
                                    <div class="col-sm-9" style="padding: 5px;line-height: 28px;"><?php echo ($info["content"]); ?></div>
                                    </h5> </div>
                            </div>
                    </div>
                </div>
