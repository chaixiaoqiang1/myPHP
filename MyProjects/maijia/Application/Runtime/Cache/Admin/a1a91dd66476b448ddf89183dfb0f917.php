        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">课程分类修改</span></li>
                    <li class="active" id="parentIframe"><span class="parentIframe iframeurl"></span></li>
                    <li class="active" id="parentIfour"><span class="parentIfour iframeurl"></span></li>
                </ul>
            </div>
            <form action="/maijia/index.php/Admin/Question/editor/id/22.html" method="post" enctype="multipart/form-data">
            ...
            <div class="clearfix" id="advertising">
                <div id="add_ads_style" >
                    <div class="add_adverts">
                        <ul>
                            <li>
                                <label class="label_name">课程类别</label>
                                  <span class="cont_style">
                                      <select class="form-control" id="form-field-select-1" name="type">
                                          <option>请选择课程</option>
                                          <option value="1" <?php if($info['type'] == 1): ?>selected<?php endif; ?>>青葱课</option>
                                          <option value="2" <?php if($info['type'] == 2): ?>selected<?php endif; ?>>政治课</option>
                                          <option value="3" <?php if($info['type'] == 3): ?>selected<?php endif; ?>>物理课</option>
                                          <option value="4" <?php if($info['type'] == 4): ?>selected<?php endif; ?>>是非课</option>
                                          <option value="5" <?php if($info['type'] == 5): ?>selected<?php endif; ?>>魔法课</option>
                                      </select>
                                  </span>
                            </li>
                            <li>
                                <label class="label_name">标题</label><span class="cont_style"><input name="title" type="text" id="title" placeholder="请输入标题" class="col-xs-10 col-sm-5" style="width:450px" value="<?php echo ($info['title']); ?>"></span>
                            </li>
                            <li>
                                <label class="label_name">价格</label><span class="cont_style"><input name="price" type="text" id="price" placeholder="0.00" class="col-xs-10 col-sm-5" style="width:450px" onkeyup='this.value=this.value.replace(/\D/gi,"")' value="<?php echo ($info['price']); ?>"></span>
                            </li>
                            <li><label class="label_name">图片尺寸</label><span class="cont_style">
                              <input name="width" type="text" placeholder="0" class="col-xs-10 col-sm-5" style="width:80px" onkeyup="value=value.replace(/[^0-9]/g,'')" onpaste="value=value.replace(/[^0-9]/g,'')" oncontextmenu = "value=value.replace(/[^0-9]/g,'')" value="<?php echo ($info["size"]["0"]); ?>">
                              <span class="l_f" style="margin-left:10px;">x</span><input name="height" type="text" id="form-field-1" placeholder="0"
                                                                                         class="col-xs-10 col-sm-5" style="width:80px"  onkeyup="value=value.replace(/[^0-9]/g,'')" onpaste="value=value.replace(/[^0-9]/g,'')" oncontextmenu = "value=value.replace(/[^0-9]/g,'')" value="<?php echo ($info["size"]["1"]); ?>"></span>
                            </li>
                         <!--   <li>
                                <label class="label_name">链接地址</label><span class="cont_style"><input name="地址" type="text" id="form-field-2" placeholder="地址" class="col-xs-10 col-sm-5" style="width:450px"></span>
                            </li>-->
                            <li><label class="label_name">状&nbsp;&nbsp;态：</label>
                                <?php if($vo['status'] == 1): ?><span class="cont_style">
                                 &nbsp;&nbsp;<label><input name="status" type="radio"  class="ace" value="1"><span
                                       class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;
                                 <label><input name="status" type="radio" class="ace" value="2" checked="checked"><span class="lbl" >隐藏</span></label></span>
                                    <?php else: ?>
                                     <span class="cont_style">
                                 &nbsp;&nbsp;<label><input name="status" type="radio"  class="ace" value="1" checked="checked"><span
                                             class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;
                                 <label><input name="status" type="radio" class="ace" value="2" ><span class="lbl" >隐藏</span></label></span><?php endif; ?>
                                <div class="prompt r_f"></div>
                            </li>
                            <li><label class="label_name">图片</label><span class="cont_style">
                                <div class="prompt" style="top:150px; left: 0;"><p>图片大小小于5MB,支持.jpg;.gif;.png;.jpeg格式的图片</p></div>
                                 <div class="demo">
...
<script>
    $("#tijiao01").click(function(){
        ...
        if($("#form-field-select-1").val() == "请选择课程"){
            alert("请选择课程");
            return false;
        }
        if(!$("#title").val()){
