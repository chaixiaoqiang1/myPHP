        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">用户列表</span></li>
                ...
                <div id="Member_Ratings">
                    <div class="d_Confirm_Order_style">
                        ...
                        <div class="search_style" style="height: 80px">
                            ...
                            <ul class="search_content clearfix" style="height: 50px">
                                <li><label class="l_f">用户名称</label><input name="name" type="text" class="text_add"
                                                                          placeholder="输入名称关键字"
                                                                          style=" width:60%"/></li>
                                <li><label class="l_f">手机号码</label><input name="phone" type="text" class="text_add"
                                                                          placeholder="输入手机号码关键字"
                                                                          style=" width:60%"/></li>
                                <li><label class="l_f">添加时间</label><input class="inline laydate-icon" id="start" name="add_time"
                        ...
                        <!---->
                        <div class="table_menu_list" style="height: 70px">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <form action="<?php echo U('User/delete_all');?>" id="form01">
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><label><input type="checkbox" class="ace" name="checks[]" value="<?php echo ($vo["id"]); ?>"><span class="lbl"></span></label></td>
                                    <td>
                                           <?php echo ($vo["name"]); ?>
                                    </td>
                                    <td><?php echo ($vo["phone"]); ?></td>
                                    <td>
                                        <img src="<?php echo ($vo["icon"]); ?>"  style=" height: 100px; width: 100px; border-radius: 50%;"/>
                                    </td>
                                    <td>
                                        <?php if($vo['role'] == 2): ?>车主
                                            <?php else: ?>
                                    ...
                                    <td class="td-manage">
                                        ...
                                        <?php else: ?>
                                        <td class="td-status"><span class="label label-defanut radius">已停用</span></td>
                                        <td class="td-manage">
                                        ...
                                        <a title="查看详情"  href="<?php echo U('User/see',array('id'=> $vo['id']));?>"
...
<script type="text/javascript">
    ...
    function member_stop(obj, id) {
        layer.confirm('确认要停用吗？', function (index) {
            $.post("<?php echo U('User/edit_status');?>",{'id':id},function(data){
                if(data ==  'ok'){
                    location.reload();
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post("<?php echo U('User/del');?>",{'id':id},function(data){
                if(data == 'ok'){
