...
<head>
    ...
    <![endif]-->
    <script src="/maijia/Public/new//maijia/Public/new/assets/js/ace-extra.min.js"></script>
    <!--[if lt IE 9]>
    <script src="/maijia/Public/new//maijia/Public/new/assets/js/html5shiv.js"></script>
    <script src="/maijia/Public/new//maijia/Public/new/assets/js/respond.min.js"></script>
    <![endif]-->
            ...
            <div id="login-box" class="login-box widget-box no-border visible">
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div class="login_icon"><img src="/maijia/Public/new/images/login.png" /></div>

                        <form class="<?php echo U('Pubic/login');?>" method="post">
                            <fieldset>
                                <label class="block clearfix">
										<span class="block input-icon input-icon-right">
											<input type="text" class="form-control" required placeholder="登录名"  name="username">
											<i class="icon-user"></i>
										</span>
                                </label>
...
-->
                                    <button type="submit" class="width-35  btn btn-sm btn-primary" id="login_btn">
                                        <i class="icon-key"></i>
                                        登陆
                                    </button>
                                </div>
...
<div class="loginbm">版权所有  2016  <a href="http://www.xadamai.com/">西安大麦网络科技有限公司</a> </div><strong></strong>
</body>
</html>
<script>
    $('#').on('click', function(){
