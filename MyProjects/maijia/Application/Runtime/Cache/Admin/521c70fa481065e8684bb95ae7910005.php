            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo U('Ask/index');?>">问题管理</a>
                    </li>
                    <li class="active"><span class="Current_page iframeurl">问题详情查看</span></li>
                        ...
                        <div class="" id="wd">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <table class="table table-bordered" border="1">
                                    <tr>
                                        <th rowspan="3" width="180" class="text-center"> <img src="/maijia/<?php echo ($info['user_id']['icon']); ?>"  style=" margin-top: 5px; height: 150px; width: 150px; border-radius: 50%;"/></th>
                                        <td>发布者：<?php echo ($info['user_id']['name']); ?></td>
                                        <td>获赞数：<?php echo ($info['praise']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>分享数：<?php echo ($info['share']); ?></td>
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12" style="margin-top: 20px; margin-bottom: 50px;">
                                <div class="col-md-12 col-lg-12 col-sm-12"style="border: 1px solid #E3E3E3;">
                                    <p class="text-center" style="margin: 15px auto 15px auto;"> <?php echo ($info["title"]); ?></p>
                                </div>
                                <div class="col-md-12 col-lg-12 col-sm-12"style="border: 1px solid #E3E3E3;">
                                    <?php if($info['img']): ?><div class="row" style="margin-top: 20px;">
                                        <p>
                                            <h4>展示图：</h4>
                                        </p>
                                        <p style="margin-top: 15px;padding-left: 25px;"><img src="/maijia/<?php echo ($info["img"]); ?>" style="border: 4px dashed #e0e0e0;" /></p>
                                    </div><?php endif; ?>
                                    <div class="row" style="margin-top: 20px; margin-bottom: 20px;">
                                        <p>
                                            <h4>详细描述：</h4>
                                        </p>
                                        <p style="margin-top: 15px;padding-left: 25px; line-height: 24px;"><?php echo ($info["content"]); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
