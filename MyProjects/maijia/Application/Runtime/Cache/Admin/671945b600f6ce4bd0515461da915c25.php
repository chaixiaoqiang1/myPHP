        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">用户详情查看</span></li>
                        ...
                        <div class="" id="wd">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <table class="table table-bordered" border="1">
                                    <tr>
                                        <th rowspan="3" width="180" class="text-center"> <img src="/maijia/Public/new/products/ad.jpg"  style=" margin-top: 5px; height: 150px; width: 150px;"/></th>
                                        <td>名称：<?php echo ($info["name"]); ?></td>
                                        <td>手机号码：<?php echo ($info["phone"]); ?></td>
                                        <td>添加时间：<?php echo ($info["add_time"]); ?></td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <?php if($info['is_com'] == 2): ?>角色：车主
                                            <?php else: ?>角色：用户<?php endif; ?>
                                    </td>
                                           <td>
                                        <?php if($info['is_com'] == 1): ?>评车付费：已付费
                                            <?php else: ?>
                                            评车付费：未付费<?php endif; ?>
                                        &nbsp;
                                        <?php if($info['is_ask'] == 1): ?>问车付费：已付费
                                            <?php else: ?>
                                            问车付费：未付费<?php endif; ?>
                                    </td>
                                        <?php if(in_array(2,$info['course_pay'])): ?><td>政治课付费：已付费</td>
                                            <?php else: ?>
                                            <td>政治课付费：未付费</td><?php endif; ?>
                                    </tr>
                                    <tr>
                                        <?php if(in_array(3,$info['course_pay'])): ?><td>物理课付费：已付费</td>
                                            <?php else: ?>
                                            <td>物理课付费：未付费</td><?php endif; ?>
                                        <?php if(in_array(4,$info['course_pay'])): ?><td>是非课付费：已付费</td>
                                            <?php else: ?>
                                            <td>是非课付费：未付费</td><?php endif; ?>
                                        <?php if(in_array(5,$info['course_pay'])): ?><td>魔法课付费：已付费</td>
                                            <?php else: ?>
                                            <td>魔法课付费：未付费</td><?php endif; ?>
                                    </tr>
                                    <?php if($info['is_com'] == 2): ?><tr>
                                        <td>车主汽车品牌：<?php echo ($info["my_brand"]); ?></td>
                                        <td>车主汽车车系：<?php echo ($info["my_demio"]); ?></td>
                                        <td>车主汽车型号：<?php echo ($info["my_model"]); ?></td>
                                        <td>车牌号：<?php echo ($info["cart_num"]); ?> &nbsp;17位vin代码：<?php echo ($info["vin"]); ?></td>
                                    </tr><?php endif; ?>
                                </table>
                            </div>
                        </div>
