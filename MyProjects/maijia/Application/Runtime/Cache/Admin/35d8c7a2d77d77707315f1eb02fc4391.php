                        ...
                        <div class="" id="wd">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <table class="table table-bordered" border="1">
                                    <tr>
                                        <th rowspan="3" width="180" class="text-center"> <img src="/maijia/<?php echo ($info["img"]); ?>"  style=" margin-top: 5px; height: 150px; width: 150px; border-radius: 50%;"/></th>
                                        <td>回答者：<?php echo ($info['user_id']); ?></td>
                                        <td>获赞数：<?php echo ($info['com_praise']); ?></td>
                                    </tr>
                                    <tr>
                                        <td>添加时间：<?php echo ($info['add_time']); ?></td>
                                        <?php if($info['status'] == 1): ?><td>状态：正常</td>
                                            <?php else: ?>
                                            <td>状态：冻结</td><?php endif; ?>
                                    </tr>
                                </table>
                            </div>
