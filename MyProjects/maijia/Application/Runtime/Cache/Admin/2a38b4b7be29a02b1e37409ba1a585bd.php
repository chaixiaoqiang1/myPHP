            ...
            <div class=" clearfix" id="advertising">
                ...
                <div class="Ads_list"  style="width: 1730px">
                    <div class="search_style" style="height: 80px">
                        ...
                        <form action="/maijia/index.php/Admin/Brand/index" method="get">
                            <ul class="search_content clearfix">
                                <li><label class="l_f">品牌</label><input name="key" type="text" class="text_add" placeholder="输入品牌关键字"
                    ...
                    <div class="border clearfix">
                       <span class="l_f">
                        ...
                        <span class="r_f">共：<b><?php echo ($count); ?></b>条图片</span>
                    </div>
                      <table class="table table-striped table-bordered table-hover" id="sample-table">
                            <thead>
                            <tr>
                                <th width="25"><label><input type="checkbox" id="all_che"   class="ace"><span
                          ...
                          <?php if(is_array($brands)): foreach($brands as $key=>$v): ?><tbody>
                            <tr>
                                <td><label><input name="id" type="checkbox" value="<?php echo ($v["id"]); ?>" class="ace"><span class="lbl"></span></label></td>
                                <td><?php echo ($v["id"]); ?></td>
                                <td><?php echo ($v["name"]); ?></td>
                                <td style="text-align: center;">
                                    <img src="/maijia/<?php echo ($v["img"]); ?>"  style="border-radius: 50%; height: 80px; width: 80px;"/>
                                </td>
                                <td><?php echo ($v["size"]); ?></td>
                                <td ><input class="text-center" type="text" id="order<?php echo ($v["id"]); ?>" onchange="orderChange(<?php echo ($v["id"]); ?>)" value="<?php echo ($v["order"]); ?>" style="width: 30px;"></td>
                                <td><?php echo ($v["time"]); ?></td>
                                <?php if($v["status"] == 1): ?><td class="td-status"><span class="label label-success radius">显示</span></td>
                                     <td class="td-manage">
                                ...
                                <?php else: ?>
                                    ...
                                    <td class="td-manage">
                                        <a style="text-decoration:none" class="btn btn-xs " onClick="member_start(this,<?php echo ($v["id"]); ?>)" href="javascript:;" title="显示"><i class="fa fa-close bigger-120"></i></a><?php endif; ?>
                                    <a title="编辑" onclick="member_edit('编辑','member-add.html','4','','510')"
                                       href="javascript:update(<?php echo ($v["id"]); ?>);" class="btn btn-xs btn-info"><i
                            ...
                            <tr><td colspan="9"><?php echo ($listShow); ?></td></tr>
                        </table>
                </div>
            </div>
...
<script>
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', {icon: 0,}, function (index) {
            $.ajax({
                type:"post",
                url:"/maijia/index.php/Admin/Brand/delete",
                data:"id="+id,
                dataType:"html",
                success:function (re){
                    if(re=="OK"){
