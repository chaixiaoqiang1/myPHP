        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">课程修改</span></li>
                    <li class="active" id="parentIframe"><span class="parentIframe iframeurl"></span></li>
                    <li class="active" id="parentIfour"><span class="parentIfour iframeurl"></span></li>
                </ul>
            </div>
            <form action="/maijia/index.php/Admin/Question/edit_course/id/46.html" method="post">
                                ...
                                <li>
                                  ...
                                  <span class="cont_style">
                                      <select class="form-control" id="form-field-select-1-bak" name="question_id">
                                          ...
                                          <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['id'] == $list['question_id']['id']): ?><option value="<?php echo ($vo["id"]); ?>" selected><?php echo ($vo["type"]); ?>/<?php echo ($vo["title"]); ?></option>
                                                  <?php else: ?>
                                                  <option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["type"]); ?>/<?php echo ($vo["title"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                      </select>
                                  </span>
                                </li>
                                <li>
                                    <label class="label_name">标题</label><span class="cont_style"><input name="title" type="text" id="" value="<?php echo ($list['title']); ?>" placeholder="请输入标题" class="col-xs-10 col-sm-5"  style="width:450px"></span>
                                </li>
                                <li>
                                    <label class="label_name" style="margin-right: 10px;">内容</label>
                                    <textarea id="editor_id" name="content" class="cont_style" rows="40"><?php echo ($list["content"]); ?></textarea>
                                </li>
                            </ul>
                        </div>
                    </div>
