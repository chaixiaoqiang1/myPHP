...
<head>
    ...
    <link href="/maijia/Public/style/admin.min.css" rel="stylesheet">
    <![endif]-->
    <!--[if !IE]> -->
    <!-- <![endif]-->
    <!--[if IE]>
        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">图片添加</span></li>
                    <li class="active" id="parentIframe"><span class="parentIframe iframeurl"></span></li>
                    <li class="active" id="parentIfour"><span class="parentIfour iframeurl"></span></li>
                </ul>
            </div>
            <form name="frm" action="<?php echo U('Banner/add');?>" method="post" enctype="multipart/form-data" onsubmit="return check()">
                ...
                <div id="add_ads_style" >
                    <div class="add_adverts">
                        <ul>
                                ...
                                <label class="label_name">所属分类</label>
                                  <span class="cont_style">
                                      <select class="form-control" id="form-field-select-1" name="type">
                                          ...
                                          <option value="3">选车课</option>
                                          <option value="4">培训</option>
                                          <option value="5">问车馆</option>
                                          <option value="6">答疑</option>
                                      </select>
                                  </span>
                            </li>
                            ...
                            <li>
                                <label class="label_name">链接地址</label><span class="cont_style"><input name="url" type="text" id="form-field-1" placeholder="地址" class="col-xs-10 col-sm-5" style="width:450px"></span>
                            </li>
                            ...
                            <li><label class="label_name">图片</label><span class="cont_style">
                                <div class="prompt" style="top:150px; left: 0;"><p>图片大小小于5MB,支持.jpg;.gif;.png;.jpeg格式的图片</p><input type="submit" class="btn btn-success" style="width:80px; margin-top: 20px;" value="添加"/></div>
                                 <div class="demo">
                                     <div class="logobox" style="width: 140px;">
                                         ...
                                         <input type="file" name="photo" id="upload"  class="upfile uplo" style="display: none;" />
                                     </div>
