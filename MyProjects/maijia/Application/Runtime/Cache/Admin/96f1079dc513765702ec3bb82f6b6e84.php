            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo U('Banner/index');?>">图片管理</a>
                    </li>
                    <li class="active"><span class="Current_page iframeurl">图片列表</span></li>
            ...
            <div class=" clearfix" id="advertising">
                ...
                <div class="Ads_list" id="" style="width: 1730px">
                    <div class="border clearfix">
                       <span class="l_f">
                        <a href="<?php echo U('Banner/add');?>" id="ads_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加图片</a>
                      ...
                      <table class="table table-striped table-bordered table-hover" id="sample-table">
                            ...
                            <tbody>
                            <?php if(is_array($banners)): foreach($banners as $key=>$v): ?><tr>
                                <td><?php echo ($v["id"]); ?></td>
                                <?php switch($v["type"]): case "1": ?><td>头部</td><?php break;?>
                                    <?php case "2": ?><td>尾部</td><?php break;?>
                                    <?php case "3": ?><td>选车课</td><?php break;?>
                                    <?php case "4": ?><td>培训</td><?php break;?>
                                    <?php case "5": ?><td>问车管</td><?php break;?>
                                    <?php case "6": ?><td>答疑</td><?php break;?>
                                    <?php default: ?>其他<?php endswitch;?>
                                <td><span class="ad_img"><img src="/maijia/<?php echo ($v["content"]); ?>" width="100%" height="100%"/></span>
                                </td>
...
<script>
    ...
    function member_stop(obj, id) {
       layer.confirm('确认要关闭吗？', {icon: 0,}, function (index) {
            $.ajax({
                type:"post",
                url:"/maijia/index.php/Admin/Banner/stop",
                data:"id="+id,
                dataType:"html",
                success:function(re){
                    if(re==1) {
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', {icon: 0,}, function (index) {
            ...
            $.ajax({
                type:"post",
                url:"/maijia/index.php/Admin/Banner/delete",
                data:"id="+id,
                dataType:"html",
                success:function(re) {
                    if(re=="OK") {
    ...
    function update(id){
            window.location="/maijia/index.php/Admin/Banner/update/id/"+id;
    }
