        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">评车项目列表</span></li>
                        ...
                        <div class="table_menu_list" id="wd">
                            <table class="table table-striped table-bordered table-hover" id="" >
                                ...
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td width="10%"><?php echo ($vo["option_name"]); ?></td>
                                        <td width="12%"><img src="/maijia/<?php echo ($vo["img"]); ?>"  style=" height: 100px; width: 100%;"/></td>
                                        <td width="5%"><?php echo ($vo["grand"]); ?></td>
                                        ...
                                        <?php if($vo['status'] == 1): ?><td class="td-status" ><span class="label label-success radius" >已启用</span></td>
                                            ...
                                            <a title="查看详情"  href="<?php echo U('Comment/see_info',array('id'=> $vo['id'],'eid'=> $vo['evaluate_id']));?>"
...
<script type="text/javascript">
    ...
    function member_stop(obj, id) {
        layer.confirm('确认要停用吗？', function (index) {
            $.post("<?php echo U('Comment/status_see');?>",{'id':id},function(data){
                if(data == 'ok'){
                    location.reload();
                    $(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" class="btn btn-xs " onClick="member_start(this,id)" href="javascript:;" title="启用"><i class="icon-close bigger-120"></i></a>');
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post("<?php echo U('Comment/del_see');?>",{'id':id},function(data){
                if(data == "ok"){
