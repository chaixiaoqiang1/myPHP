...
<div class="main-container" id="main-container">
    ...
    <script type="text/javascript">
        ...
        <div class="main-content">
            ...
            <form action="/maijia/index.php/Admin/Train/edit/id/10.html" method="post" enctype="multipart/form-data">
                                ...
                                <label class="label_name">培训类别：</label>
                                  <span class="cont_style">
                                      <select class="form-control" id="form-field-select-1" name="type">
                                          ...
                                          <option value="1" <?php if($info['type'] == 1): ?>selected<?php endif; ?>>觅车答疑/助驾服务规范</option>
                                          <option value="2" <?php if($info['type'] == 2): ?>selected<?php endif; ?>>觅驾车主测评制作约定</option>
                                      </select>
                                  </span>
                            </li>
                            <li>
                            ...
                            <li><label class="label_name">状&nbsp;&nbsp;态：</label>
                               <span class="cont_style">
                                 &nbsp;&nbsp;<label>
                                   ...
                                   <input name="status" type="radio" <?php if($info['status'] == 1): ?>checked="checked"<?php endif; ?> class="ace" value="1"><span
                                       class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;
                                 <label>
                                     <input name="status" type="radio" class="ace" <?php if($info['status'] == 2): ?>checked="checked"<?php endif; ?> value="2"><span
