            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo U('Comment/index');?>">评车管理</a>
                    </li>
                    <li class="active"><span class="Current_page iframeurl">评车列表</span></li>
                    ...
                    <div class="h_products_list clearfix" id="products_list" style="margin-top: 30px;">
                        <div class="table_menu_list" id="wd">
                            <div class="search_style" style="height: 80px">
                                ...
                                <form action="<?php echo U('Comment/info');?>" method="post">
                                    <ul class="search_content clearfix">
                                        <div id="cart_type">
                                        <li id="demio_brand">
                                            <label class="l_f" style="margin-right: 10px;">品牌</label>
                                            <select name="brands" onchange="query(this.value,1)">
                                                <!--<option value="1">获取brands表中的信息</option>-->
                                                <option value="" selected>请选择品牌</option>
                                                <?php if(is_array($brands_info)): $i = 0; $__LIST__ = $brands_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </li>
                                           </div>
                                        <li><label class="l_f">添加时间</label><input class="inline laydate-icon" name="time" id="start"
                            ...
                            <table class="table table-striped table-bordered table-hover" id="" >
                                ...
                                <form action="<?php echo U('Comment/all_del_info');?>" method="post" id="form03">
                                <tbody>
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><label><input type="checkbox" class="ace" name="ids[]" value="<?php echo ($vo["id"]); ?>"><span class="lbl"></span></label></td>
                                        <td width="5%"><?php echo ($vo["user_id"]); ?></td>
                                        <td width="10%"><?php echo ($vo["demio"]); ?></td>
                                        <td width="10%"><?php echo ($vo["model"]); ?></td>
                                        <td width="10%">
                                            <?php if($vo['type'] == 1): ?>颜值与设计
                                                <?php elseif($vo['type'] == 2): ?>驾驶与操控
                                                <?php elseif($vo['type'] == 3): ?>舒适便利性
                                                <?php elseif($vo['type'] == 4): ?>避险能力
                                                <?php elseif($vo['type'] == 5): ?>抗损耐用性
                                                <?php elseif($vo['type'] == 6): ?>通过性(SUV)<?php endif; ?>
                                        </td>

                                        <td width="5%"><?php echo ($vo["praise"]); ?></td>
                                        <td width="5%"><?php echo ($vo["share"]); ?></td>
                                        <td width="5%"><?php echo ($vo["years"]); ?>年</td>
                                        ...
                                        <td class="td-manage">
                                            ...
                                            <a title="查看详情"  href="<?php echo U('Comment/see',array('id'=>$vo['id']));?>"
...
<script type="text/javascript">
    ...
    function member_stop(obj, id) {
        layer.confirm('确认要停用吗？', function (index) {
            $.post("<?php echo U('Comment/statu_info');?>",{'id':id},function(data){
                if(data == "ok"){
                    location.reload();
