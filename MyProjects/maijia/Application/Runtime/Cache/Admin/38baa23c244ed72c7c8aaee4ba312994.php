            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo U('Test/index');?>">试车管理</a>
                    </li>
                    ...
                    <div class="h_products_list clearfix" id="products_list" style="margin-top: 30px;">
                        <div class="table_menu_list" id="wd">
                            <div class="border clearfix">
                                <span class="l_f">
                                     <a href="<?php echo U('Test/add');?>" title="添加信息" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加信息</a>
                               </span>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="" >
                                ...
                                <tbody>
                                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td width="5%">
                                            <?php if($vo['type'] == 1): ?>试乘
                                                <?php elseif($vo['type'] == 2): ?>试驾
                                                <?php else: ?>试乘<?php endif; ?>
                                        </td>
                                        <td width="5%"><?php echo ($vo["price"]); ?></td>
                                        <td width="25%"><?php echo ($vo["content"]); ?></td>
                                        <td width="5%"><?php echo date('Y-m-d H:i:s',$vo['add_time']);?></td>
                                        ...
                                        <td class="td-status"><span class="label label-defaunt radius">已停用</span></td>
                                            ...
                                            <a title="编辑"  href="<?php echo U('Test/edit',array('id'=> $vo['id']));?>"
...
<script type="text/javascript">
    ...
    function member_stop(obj, id) {
        layer.confirm('确认要停用吗？', function (index) {
            $.post("<?php echo U('Test/edit_status');?>",{'id':id},function(data){
                if(data == 'ok'){
                    location.reload();
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post("<?php echo U('Test/del_test');?>",{'id':id},function(data){
                if(data == 'ok'){
