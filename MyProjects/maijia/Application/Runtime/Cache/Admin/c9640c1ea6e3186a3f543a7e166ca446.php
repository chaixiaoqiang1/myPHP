        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span class="Current_page iframeurl">评论列表</span></li>
            ...
            <div class="margin clearfix">
                <div class="Guestbook_style">
                    <div class="search_style">
                        ...
                        <form action="<?php echo U('Question/course_com');?>" method="post">
                            <ul class="search_content clearfix" style="height: 30px">
                            <li><label class="l_f">留言</label><input name="content" type="text" class="text_add"
                                                                    placeholder="输入留言信息" style=" width:250px"></li>
                            <li><label class="l_f">时间</label><input name="time" class="inline laydate-icon" id="start"
                    ...
                    <div class="Guestbook_list">
                        <table class="table table-striped table-bordered table-hover" id="sample-table">
                            ...
                            <tr>
                                <th width="25"><label><input type="checkbox" class="ace" id="ace_one"><span
                            ...
                            <form action="<?php echo U('Question/delall_course_com');?>" method="post" id="form03">
                            <tbody>
                            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><label><input type="checkbox" class="ace" name="allid[]" value="<?php echo ($vo["id"]); ?>"><span class="lbl"></span></label></td>
                                <td><?php echo ($vo["id"]); ?></td>
                                <td><span style="cursor:pointer" class="text-primary"
                                       onclick="member_show('<?php echo ($vo["user_id"]); ?>','member-show.html','1031','500','400')"><?php echo ($vo["user_id"]); ?></span></td>
                                <td class="text-l">
                                    <span href="javascript:;" onclick="Guestbook_iew('12')"><?php echo mb_substr($vo['content'],0,15,'utf-8');?>...</span>
                                ...
                                <?php if($vo['status'] == 1): ?><td class="td-status"><span class="label label-success radius">已启用</span></td>
                                    ...
                                    <a title="查看详情" href="<?php echo U('Question/liuyan',array('id'=>$vo['id']));?>"
                                  ...
                                  <!--  <a onClick="member_stop(this,'10001')" href="javascript:;" title="已浏览"
                                    ...
                                    <a onclick="member_edit('回复','member-add.html','4','','510')" title="回复"
                                       href="javascript:;" class="btn btn-xs btn-info"><i
                                            class="fa fa-edit bigger-120"></i></a>
                                    <a href="javascript:;" onclick="member_del(this,'1')" title="删除"
                    ...
                    <div id="page" style="text-align: center;margin-top: 5px"><?php echo ($page); ?></div>
                </div>
            </div>
            <!--留言详细-->
...
<script type="text/javascript">
    ...
    function member_stop(obj, id) {
        layer.confirm('确认要停用吗？', function (index) {
            $.post("<?php echo U('Question/status_course_com');?>",{'id':id},function(data){
                if(data == 'ok'){
                    location.reload();
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post("<?php echo U('Question/del_course_com');?>",{'id':id},function(data){
                if(data == 'ok'){
