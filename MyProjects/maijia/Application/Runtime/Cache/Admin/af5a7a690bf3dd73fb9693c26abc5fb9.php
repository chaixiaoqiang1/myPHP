    ...
    <script type="text/javascript">
        ...
        <div class="main-content">
            ...
            <div class=" clearfix" id="advertising">
                <form name="frm" action="<?php echo U('Test/edit');?>" method="post" enctype="multipart/form-data" onsubmit="return check()" id="form01">
                            ...
                            <li>
                                ...
                                <span class="cont_style">
                                      <select class="form-control" id="form-field-select-1" name="type">
                                          ...
                                          <option value="1"  <?php if($info['type'] == 1): ?>selected<?php endif; ?>>试乘</option>
                                          <option value="2"  <?php if($info['type'] == 2): ?>selected<?php endif; ?>>试驾</option>
                                      </select>
                                    </span>
                            </li>
                            <li>
                                <label class="label_name" style="margin-right: 10px; width: 100px;">价格</label>
                                <span class="cont_style"><input name="price" type="text" id="price" placeholder="请输入价格" value="<?php echo ($info["price"]); ?>" class="col-xs-10 col-sm-5" style="width:450px" onkeyup="value=value.replace(/[^0-9]/g,'')" onpaste="value=value.replace(/[^0-9]/g,'')" oncontextmenu = "value=value.replace(/[^0-9]/g,'')"></span>
                            </li>
                            <li><label class="label_name" style="margin-right: 10px; width: 100px;">状&nbsp;&nbsp;态：</label>
                               <span class="cont_style">
                                   <?php if($info['status'] == 1): ?>&nbsp;&nbsp;<label><input name="status" value="1" type="radio" checked="checked" class="ace"><span
                                ...
                                &nbsp;&nbsp;<label><input name="status" value="1" type="radio" class="ace"><span
                                        class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;
                                <label><input name="status" value="2" type="radio" checked="checked" class="ace"><span class="lbl">隐藏</span></label></span>
                                <div class="prompt r_f"></div><?php endif; ?>
                            </li>
                            <li><label class="label_name" style="margin-right: 10px; width: 100px;">详情：</label>
                                 <span class="cont_style" style="display: inline-block;">

                                    &nbsp;&nbsp;<textarea name="content" id="" cols="30" rows="10" style="border: 1px solid #E3E3E3;"><?php echo ($info["content"]); ?></textarea>
                                 </span>
                            </li>
                        </ul>
                    </div>
