            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo U('Ask/index');?>">问车馆管理</a>
                    </li>
                    <li class="active"><span class="Current_page iframeurl">问题列表</span></li>
                    ...
                    <div class="h_products_list clearfix" id="products_list" style="margin-top: 30px;">
                        <div class="table_menu_list" id="wd">
                            <div class="search_style" style="height: 80px">
                                ...
                                <form action="<?php echo U('Ask/index');?>" method="post">
                                    <ul class="search_content clearfix">
                                        <li>
                                            <label class="l_f">问题关键字</label><input name="title" type="text" class="text_add" placeholder="问题关键字"
                            ...
                            <table class="table table-striped table-bordered table-hover" id="" >
                                ...
                                <form action="<?php echo U('Ask/delete_all');?>" method="post" id="form01">
                                <tbody>
                                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><label><input type="checkbox" name="checks[]"  value="<?php echo ($vo["id"]); ?>"  class="ace"><span class="lbl"></span></label></td>
                                        <td width="5%"><?php echo ($vo["user_id"]); ?></td>
                                        <td width="25%"><?php echo ($vo["title"]); ?></td>
                                        ...
                                        <td class="td-manage">
                                            ...
                                            <a title="查看详情"  href="<?php echo U('Ask/see',array('id'=>$vo['id']));?>"
                                            ...
                                            <a title="查看回答信息" href="<?php echo U('Ask/see_ask_info',array('id'=>$vo['id']));?>"
...
<script type="text/javascript">
    ...
    function member_stop(obj, id) {
        layer.confirm('确认要停用吗？', function (index) {
            $.post("<?php echo U('Ask/edit_status');?>",{'id':id},function(data){
                if(data == 'ok'){
                    location.reload();
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post("<?php echo U('Ask/del');?>",{'id':id},function(data){
                if(data == 'ok'){
