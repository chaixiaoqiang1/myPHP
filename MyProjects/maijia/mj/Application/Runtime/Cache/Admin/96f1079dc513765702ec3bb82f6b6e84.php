            ...
            <div class=" clearfix" id="advertising">
                ...
                <div class="Ads_list" id="" style="width: 1730px">
                    <div class="border clearfix">
                       <span class="l_f">
                        <a href="<?php echo U('Banner/add');?>" id="ads_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加广告</a>
                      ...
                      <table class="table table-striped table-bordered table-hover" id="sample-table">
                            ...
                            <tr>
                                ...
                                <td>1</td>
                                <td>幻灯片</td>
                                <td><span class="ad_img"><img src="/mj/Public/new/products/ad.jpg" width="100%" height="100%"/></span>
                                </td>
                                <td>1890x1080</td>
