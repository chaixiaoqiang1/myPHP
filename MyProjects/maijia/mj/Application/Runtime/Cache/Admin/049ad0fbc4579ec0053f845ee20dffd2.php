            ...
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="<?php echo U('Banner/index');?>">课程管理</a>
                    </li>
            ...
            <div class=" clearfix" id="advertising">
                ...
                <div class="Ads_list" id="" style="width: 1730px">
                    <div class="border clearfix">
                       <span class="l_f">
                        <a href="<?php echo U('Question/add');?>" id="ads_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加课程</a>
                        <a href="javascript:ovid()" class="btn btn-danger"><i class="fa fa-trash"></i> 批量删除</a>
                       </span>
                        <span class="r_f">共：<b>45</b>条记录</span>
                    </div>
                      <table class="table table-striped table-bordered table-hover" id="sample-table">
                            <thead>
                            <tr>
                                <th width="5%"><label><input type="checkbox" class="ace"><span
                            ...
                            <tr>
                                ...
                                <td>如何快速从汽车小白变青葱？</td>
                                <td>10.00</td>
                                <td class=""><span class="ad_img"><img src="/mj/Public/new/products/ad.jpg" width="100%" height="100%"/></span>
                                </td>
                                <td>1890x1080</td>
